...
#include "FortSpaghettiVehicle.generated.h"
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<UFortSpaghettiVehicleConfigs> FortSpaghettiVehicleConfigsClass;
...
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    UFortSpaghettiVehicleConfigs* FortSpaghettiVehicleConfigs;
...
public:
    ...
    void SetTowhookProjectile(AFortSpaghettiTowhookAttachableProjectile* ProjectileActor);
